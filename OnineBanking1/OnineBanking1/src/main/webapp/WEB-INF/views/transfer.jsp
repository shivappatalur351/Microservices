...
<body>
	<div>
		<ul>
			...
			<li class="active"><a href="/toself">Transfer to Self</a></li>
	...
	<div class="nit">
		<div class="container">
			...
			<div class="content">
				<c:choose>
					<c:when test="${isSelfTransfer == 1}">
						<h3 class="h1">Transferred Successful</h3>
						<br>
					</c:when>

					<c:when test="${isSelfTransfer == 0}">
				...
				<form:form action="/toself" method="post" modelAttribute="toself">
